...
- [kdmp-parser](https://github.com/0vercl0k/kdmp-parser) / [udmp-parser](https://github.com/0vercl0k/udmp-parser): C++ libraries to parse Windows kernel and usermode dumps ([udmp-parser-rs](https://crates.io/crates/udmp-parser-rs) / [kdmp-parser-rs](https://crates.io/crates/kdmp-parser) for Rust crates),
